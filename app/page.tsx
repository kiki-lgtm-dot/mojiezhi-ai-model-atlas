...
export default function Home() {
  ...
  return (
    <div className="site-shell">
      ...
      <main id="top">
        <section className="hero">
          ...
          <aside className="issue-card" aria-label="本期摘要">
            ...
            <dl><div><dt>订阅档位</dt><dd>52 个</dd></div><div><dt>时间轴</dt><dd>108 个节点</dd></div><div><dt>API 价格</dt><dd>58 条</dd></div><div><dt>公开案例</dt><dd>26 个</dd></div></dl>
          </aside>
        </section>
      ...
      <footer><span>模界志 · AI 模型决策周报</span><span>完整数据集：52 个订阅档位 · 24 家模型厂商 · 58 条 API 价格 · 26 个案例</span><span>每周一更新 · 最后核验 {updateBrief.lastVerified}</span></footer>
    </div>
  );
}
