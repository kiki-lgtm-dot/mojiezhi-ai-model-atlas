...
export const updateBrief = {
  ...
  nextReview: '2026-09-28 09:00',
  scope: '订阅档位 · API 价格 · 模型发布 · 应用案例',
  changes: [
    { type: '模型发布', title: '实时语音与专业 Agent 更新', detail: 'Gemini 3.8 Live、xAI Voice Transcribe 2.0 和 Antigravity 9 月版上线；GPT-6 Astra Law 仅向获选机构开放；补入 Step 5 Preview。' },
    { type: 'API 价格', title: '模型 Token 与视频秒价分开更新', detail: 'DeepSeek V4 Pro 原厂闲时价修正为 ¥4.5 / ¥13.5；新增 Step 5 Preview、GLM-5.3-Flash、Qwen3.8 Omni Flash、腾讯云托管 Kimi K2.8；另补 MiniMax H3 视频秒价。' },
    { type: '订阅权益', title: '高阶额度与 API credits 补齐', detail: '补齐 ChatGPT Pro 两档精确消息限额、Claude Pro 新权益、Mistral Vibe Pro API credits，以及 Kimi Code 5 小时 / 周限额。' },
    { type: '案例与生命周期', title: '历史来源对账并补案例', detail: 'Antigravity 旧版仅计划 10 月 5 日停用；新增 Perplexity × Astra 案例，修正 Notion、Replit、MiniMax Agent 等历史案例来源与模型口径。' },
  ],
};
...
export const vendors: Vendor[] = [
  { region: '海外', vendor: 'OpenAI', family: 'GPT-6 Astra / Astra Law / GPT-5.6 / Cyber / GPT-Live / Sora', route: '前沿闭源', positioning: '复杂推理、代码 Agent、多模态与开发者平台；法律版仅获选机构可用', capabilities: ['推理', '代码', '多模态'], deployment: 'API / 云市场；Astra Law 目前限 ChatGPT / Codex Trusted Access', price: 'Astra $10 / $50；Cyber $12.50 / $75；Luna $0.20 / $1.20', source: 'https://developers.openai.com/api/docs/models/gpt-5.6-cyber' },
  ...
  { region: '海外', vendor: 'Google DeepMind', family: 'Gemini 3.8 / Live / Antigravity / Gemma / Lyria', route: '原生多模态', positioning: '搜索、多模态、长上下文、实时语音与 Workspace 生态', capabilities: ['多模态', '搜索', '长上下文'], deployment: 'Gemini API / Vertex AI / 端侧', price: '3.8 Flash 推广价 $0.75 / $3.75；Flash-Lite $0.30 / $2.50', source: 'https://ai.google.dev/gemini-api/docs/changelog' },
  ...
  { region: '海外', vendor: 'xAI', family: 'Grok 4.6 / Voice Transcribe 2.0 / Imagine', route: '实时搜索与 Agent', positioning: '实时网页与 X 搜索、代码、语音和内容生成', capabilities: ['推理', '搜索', '语音'], deployment: 'xAI API / 云市场', price: 'Grok 4.6 $2 / $6（短上下文）', source: 'https://docs.x.ai/developers/release-notes' },
  ...
  { region: '国内', vendor: '阿里云 / 通义千问', family: 'Qwen3.8 / Qwen3.8 Omni Flash / Qwen Coder / VL', route: '开放生态', positioning: '中文、代码、全模态与开放权重模型生态', capabilities: ['中文', '代码', '开放权重'], deployment: '百炼 API / 云市场 / 自建', price: 'Qwen3.8-Max ≤1M ¥12 / ¥36；Omni Flash ¥0.8 / ¥2.7', source: 'https://help.aliyun.com/zh/model-studio/model-pricing' },
  ...
  { region: '国内', vendor: '智谱 AI', family: 'GLM-5.3 / GLM-5.3-Flash / GLM Coding', route: '中文 Agent', positioning: '中文 Agent、代码、工具调用与开放模型', capabilities: ['Agent', '中文', '私有化'], deployment: 'BigModel API / 自建', price: 'GLM-5.3 ¥8 / ¥28；5.3-Flash 标准价 ¥0.8 / ¥2.8', source: 'https://bigmodel.cn/pricing' },
  { region: '国内', vendor: 'DeepSeek', family: 'DeepSeek V4.1 / R1', route: '高性价比推理', positioning: '推理、代码、原生视觉、开放权重与低成本 API', capabilities: ['推理', '代码', '低成本'], deployment: 'API / 自建 / 云厂商托管', price: 'V4.1 Flash 闲时 ¥1 / ¥4；V4 Pro 闲时 ¥4.5 / ¥13.5；忙时另计', source: 'https://api-docs.deepseek.com/zh-cn/quick_start/pricing/' },
  ...
  { region: '国内', vendor: 'MiniMax', family: 'M3 / M2.7 / H3 视频 / Speech', route: 'Agent 与内容生成', positioning: '长任务 Agent、语音、视频、角色互动与办公', capabilities: ['Agent', '语音', '视频'], deployment: 'API / 订阅 / 专属部署', price: 'M3 ≤512K 永久五折 ¥2.1 / ¥8.4；H3 视频 768P 输出 ¥0.50/秒，输入素材另计', source: 'https://platform.minimax.cn/docs/guides/pricing-paygo' },
  ...
  { region: '国内', vendor: '阶跃星辰', family: 'Step 5 Preview / Step-3.7 Flash / Step Audio', route: '多模态与 Agent', positioning: 'Agent、搜索、代码及多模态工具调用；Step 5 为预览版', capabilities: ['Agent', '多模态', '低成本'], deployment: 'API / 本地工作站', price: 'Step 5 Preview ¥7 / ¥20；Step-3.7 Flash ¥1.35 / ¥8.1', source: 'https://platform.stepfun.com/docs/zh/guides/pricing/details' },
...
export const subscriptionPlans: SubscriptionPlan[] = [
  ...
  { region: '海外', vendor: 'OpenAI', product: 'ChatGPT', plan: 'Pro 5×', monthlyFee: '$100 / 月', coreModel: 'GPT-6 Pro（由 GPT-6 Astra 驱动）/ GPT-5.6 Sol Pro、Codex', benefits: '约 5× Plus 用量；GPT-6 Pro 与 GPT-5.6 Sol Pro 共用每周 50 条 Chat 配额；更高优先级 Codex 与 Deep Research', note: 'Chat 与 Work / Codex 额度分开；API 另计。', uses: ['写代码', '做研究'], paid: true, source: 'https://help.openai.com/en/articles/20001354-gpt-56-and-gpt-6-pro-in-chatgpt' },
  { region: '海外', vendor: 'OpenAI', product: 'ChatGPT', plan: 'Pro 20×', monthlyFee: '$200 / 月', coreModel: 'GPT-6 Pro（由 GPT-6 Astra 驱动）/ GPT-5.6 Sol Pro、Codex', benefits: '约 20× Plus 用量；GPT-6 Pro 每周 200 条、Sol Pro 每天 170 条，两者合计每天最多 200 条 Chat 配额', note: '2026-09-10 起暂停新注册和升级；存量续费不变，合资格老用户停用后 30 天内有一次回归例外。', uses: ['写代码', '做视频', '做研究'], paid: true, source: 'https://help.openai.com/en/articles/20001354-gpt-56-and-gpt-6-pro-in-chatgpt' },
  ...
  { region: '海外', vendor: 'Anthropic', product: 'Claude', plan: 'Pro', monthlyFee: '$20 / 月', coreModel: 'Fable 5.1、Sonnet、Opus、Haiku，以选择器与 credits 为准', benefits: 'Claude Code、Cowork、Design、Slides、Docs、Science、Research、Microsoft 365 与无限 Projects', note: 'Fable 5.1 可通过 usage credits 使用；年付折算约 $17/月。', uses: ['写稿办公', '写代码', '做研究'], paid: true, source: 'https://claude.com/pricing' },
  ...
  { region: '海外', vendor: 'Mistral AI', product: 'Vibe', plan: 'Pro', monthlyFee: '$14.99 / 月', coreModel: 'Mistral Medium（套餐未锁定单一模型）', benefits: '完整 Vibe 权限；支持 CLI、IDE 与 Web 编码及长任务；更高消息、搜索、图像额度；每月 $30 API credits', note: '美元展示价未含税；通过学生资格验证后同一 Pro 套餐为 $5.99/月、每月 $15 API credits。', uses: ['日常问答', '写稿办公', '写代码', '做研究'], paid: true, source: 'https://mistral.ai/pricing/' },
  ...
  { region: '国内', vendor: '月之暗面', product: 'Kimi', plan: 'Andante', monthlyFee: '¥49 / 月', coreModel: 'Kimi K3 / K2.6、Kimi Code（K2.8 Preview）', benefits: '约 30 个 Agent、4× 优先队列、专业数据库约 1000 次', note: '会员功能共享 Token 额度池；Kimi Code 另有 5 小时 / 周限额，支持 1M 上下文。', uses: ['写稿办公', '写代码'], paid: true, source: 'https://www.kimi.com/help/membership/membership-pricing' },
  { region: '国内', vendor: '月之暗面', product: 'Kimi', plan: 'Moderato', monthlyFee: '¥99 / 月', coreModel: 'Kimi 当前模型、Kimi Code（K2.8 Preview）', benefits: '约 60 个 Agent、任务并行 2、Agent 集群 25 次、专业数据库约 2000 次', note: '会员功能共享 Token 额度池；Kimi Code 另有 5 小时 / 周限额，支持 1M 上下文。', uses: ['写稿办公', '写代码', '做研究'], paid: true, source: 'https://www.kimi.com/help/membership/membership-pricing' },
  { region: '国内', vendor: '月之暗面', product: 'Kimi', plan: 'Allegretto', monthlyFee: '¥199 / 月', coreModel: 'Kimi 当前模型、Kimi Code（K2.8 Preview）', benefits: '约 150 个 Agent、Agent 集群 50 次、Kimi Claw 群聊、专业数据库约 5000 次', note: '会员功能共享 Token 额度池；Kimi Code 另有 5 小时 / 周限额，支持 1M 上下文。', uses: ['写稿办公', '写代码', '做研究'], paid: true, source: 'https://www.kimi.com/help/membership/membership-pricing' },
  { region: '国内', vendor: '月之暗面', product: 'Kimi', plan: 'Allegro', monthlyFee: '¥699 / 月', coreModel: 'Kimi 当前模型、Kimi Code（K2.8 Preview）', benefits: '约 360 个 Agent、任务并行 4、Agent 集群 120 次和百万 Tokens 长对话', note: '会员功能共享 Token 额度池；Kimi Code 另有 5 小时 / 周限额，支持 1M 上下文。', uses: ['写稿办公', '写代码', '做研究'], paid: true, source: 'https://www.kimi.com/help/membership/membership-pricing' },
...
export const prices: PriceRow[] = [
  ...
  { vendor: 'Qwen', model: 'Qwen3.8 Omni Flash', currency: 'CNY', input: .8, cached: .1, output: 2.7, tier: '低成本', condition: '中国内地 qwen3.8-omni-flash；图像、音频等输入需按官方多模态计量规则复核', source: 'https://help.aliyun.com/zh/model-studio/model-pricing' },
  ...
  { vendor: '智谱', model: 'GLM-5.3-Flash', currency: 'CNY', input: .8, cached: .23, output: 2.8, tier: '低成本', condition: '标准价；官网另列限时五折 ¥0.4 / ¥0.115 / ¥1.4，未公布截止日', source: 'https://bigmodel.cn/pricing' },
  ...
  { vendor: 'DeepSeek', model: 'DeepSeek V4 Pro', currency: 'CNY', input: 4.5, cached: .15, output: 13.5, tier: '旗舰', condition: '原厂 V4-Pro-0813 闲时价；忙时 ¥9 / ¥0.30 / ¥27；云平台托管价不同', source: 'https://api-docs.deepseek.com/zh-cn/quick_start/pricing/' },
  ...
  { vendor: '腾讯云 TokenHub', model: 'Kimi K2.8 Preview', currency: 'CNY', input: 6.5, cached: 1.7, output: 27, tier: '均衡', condition: '腾讯云托管版；与 Kimi 原厂 K2.7 Code API 价格和模型标识不同', source: 'https://cloud.tencent.com/document/product/1823/130055' },
  ...
  { vendor: '阶跃星辰', model: 'Step 5 Preview', currency: 'CNY', input: 7, cached: .35, output: 20, tier: '旗舰', condition: '模型 ID step-5-preview；1M 上下文、64K 最大输出；仍为 Preview，未开放权重', source: 'https://platform.stepfun.com/docs/zh/guides/pricing/details' },
...
export const timeline: Record<string, { vendor: string; model: string; shift: string; source: string }[]> = {
  ...
  '2026': [
    ...
    { vendor: 'OpenAI', model: 'GPT-6 Astra Law', shift: '9 月 17 日推出法律研究组合系统；仅面向获选机构在 ChatGPT / Codex Trusted Access 使用，API 尚未开放', source: 'https://openai.com/index/astra-for-law/' },
    ...
    { vendor: 'Google', model: 'Gemini 3.8 Live / Extended Thinking', shift: '9 月 15 日两个实时语音模型 GA', source: 'https://ai.google.dev/gemini-api/docs/changelog' },
    { vendor: 'Google', model: 'Antigravity Preview 09-2026', shift: '9 月 17 日发布；05-2026 旧版已弃用，计划 10 月 5 日停用', source: 'https://ai.google.dev/gemini-api/docs/deprecations' },
    ...
    { vendor: 'xAI', model: 'grok-voice-transcribe-2.0', shift: '9 月 17 日上线；语音转写默认版本仍为 1.0', source: 'https://docs.x.ai/developers/release-notes' },
    ...
    { vendor: '阶跃星辰', model: 'Step 5 Preview', shift: '9 月核验已发布；1M 上下文、64K 输出，精确发布日期未公开；开放权重计划 10 月 15 日', source: 'https://platform.stepfun.com/docs/zh/guides/models/step-5-preview.md' },
  ],
};
...
export const cases = [
  ...
  { field: '代码 Agent', org: 'Perplexity', model: 'GPT-6 Astra', result: '用于编写通信内容、修改和监控生产系统，并生成端到端模拟测试；官方称可减少人工盯守，未披露统一量化指标', evidence: 'A｜OpenAI 案例', source: 'https://openai.com/index/perplexity-improving-accuracy-with-astra/' },
];
