...
export const updateBrief = {
  ...
  nextReview: '2026-08-31 09:00',
  scope: '订阅档位 · API 价格 · 模型发布 · 应用案例',
  changes: [
    { type: '结构更新', title: '订阅表重构', detail: '新增 45 个独立产品档位，消费者月费与开发者 API 按量价格分开。' },
    { type: '用途索引', title: '五类任务筛选', detail: '加入日常问答、写稿办公、写代码、做视频、做研究及免费档筛选。' },
    { type: '核验边界', title: '标出待复核价格', detail: '登录态、App Store 与地区差异价格均在备注中提示购买前复核。' },
  ],
};
...
export const vendors: Vendor[] = [
  { region: '海外', vendor: 'OpenAI', family: 'GPT-5.6 / Codex / Sora', route: '前沿闭源', positioning: '复杂推理、代码 Agent、多模态与开发者平台', capabilities: ['推理', '代码', '多模态'], deployment: 'API / 云市场', price: 'Luna $0.20 / $1.20；Sol $4 / $20', source: 'https://developers.openai.com/api/docs/models' },
  { region: '海外', vendor: 'Anthropic', family: 'Claude 5 / Sonnet / Opus', route: '长任务与企业安全', positioning: '长上下文、代码、工具使用与复杂企业工作流', capabilities: ['长任务', '代码', '企业'], deployment: 'API / AWS / Google Cloud', price: 'Sonnet $2 / $10；Opus $5 / $25', source: 'https://platform.claude.com/docs/en/about-claude/pricing' },
  { region: '海外', vendor: 'Google DeepMind', family: 'Gemini 3.x / Gemma', route: '原生多模态', positioning: '搜索、多模态、长上下文与 Workspace 生态', capabilities: ['多模态', '搜索', '长上下文'], deployment: 'Gemini API / Vertex AI / 端侧', price: 'Flash-Lite $0.30 / $2.50', source: 'https://ai.google.dev/gemini-api/docs/pricing' },
  { region: '海外', vendor: 'Meta', family: 'Llama 4 / Scout / Maverick', route: '开放权重生态', positioning: '开放权重、可控私有化与庞大开发者生态', capabilities: ['开放权重', '私有化', '多模态'], deployment: '自建 / 云厂商托管', price: '无统一 API 牌价，按算力与云侧计费', source: 'https://ai.meta.com/llama/' },
  ...
  { region: '海外', vendor: 'Mistral AI', family: 'Mistral 3 / Small 4 / OCR', route: '开放与私有化', positioning: '轻量模型、代码、OCR 与欧洲可控部署', capabilities: ['低成本', 'OCR', '私有化'], deployment: 'API / VPC / 自建', price: 'Small 4 $0.15 / $0.60', source: 'https://docs.mistral.ai/inference/pricing' },
  { region: '海外', vendor: 'Cohere', family: 'Command A+ / Embed / Rerank', route: '企业检索', positioning: '企业 RAG、检索、重排、多语言与数据驻留', capabilities: ['RAG', '企业', '多语言'], deployment: 'API / VPC / Model Vault', price: 'Command A+ $2.50 / $10', source: 'https://docs.cohere.com/docs/models' },
  { region: '海外', vendor: 'Amazon AWS', family: 'Nova / Bedrock 模型市场', route: '企业模型平台', positioning: '统一托管多家模型，兼顾治理、评测与企业采购', capabilities: ['模型平台', '企业', 'RAG'], deployment: 'Amazon Bedrock / SageMaker', price: '随模型、区域与吞吐档位变化', source: 'https://aws.amazon.com/bedrock/pricing/' },
  { region: '海外', vendor: 'Microsoft', family: 'Phi / MAI / Azure AI', route: '端侧与企业平台', positioning: '端侧小模型、Copilot 与 Azure 企业模型组合', capabilities: ['端侧', '企业', '工具'], deployment: '本地 / Azure / Copilot', price: '按 Azure 模型与服务计费', source: 'https://azure.microsoft.com/en-us/pricing/details/ai-foundry-models/' },
  ...
  { region: '国内', vendor: '阿里云 / 通义千问', family: 'Qwen3.8 / Qwen Coder / VL', route: '开放生态', positioning: '中文、代码、全模态与开放权重模型生态', capabilities: ['中文', '代码', '开放权重'], deployment: '百炼 API / 云市场 / 自建', price: 'Qwen3-Max ≤32K ¥2.5 / ¥10', source: 'https://help.aliyun.com/zh/model-studio/model-pricing' },
  { region: '国内', vendor: '百度 / 文心 ERNIE', family: 'ERNIE 5.x / 4.5 Turbo', route: '企业知识与搜索', positioning: '中文知识、搜索、企业 RAG、Agent 与私有化', capabilities: ['中文', 'RAG', '企业'], deployment: '千帆 API / 专属资源 / 私有化', price: '4.5 Turbo ¥0.8 / ¥3.2', source: 'https://cloud.baidu.com/doc/qianfan/s/wmh4sv6ya' },
  ...
  { region: '国内', vendor: '腾讯 / 混元', family: 'Hunyuan Hy3 / 图像 / 3D', route: '企业与工具生态', positioning: '中文、企业 Agent、办公、代码及社交内容生态', capabilities: ['企业', 'Agent', '多模态'], deployment: '腾讯云 API / 专属部署', price: 'Hy3 ¥1 / ¥4；缓存读取 ¥0.25', source: 'https://cloud.tencent.com/document/product/1823/130055' },
  { region: '国内', vendor: '智谱 AI', family: 'GLM-5.x / GLM Coding', route: '中文 Agent', positioning: '中文 Agent、代码、工具调用与开放模型', capabilities: ['Agent', '中文', '私有化'], deployment: 'BigModel API / 自建', price: 'FlashX ¥0.5 / ¥3；Flash 免费限额', source: 'https://bigmodel.cn/pricing' },
  { region: '国内', vendor: 'DeepSeek', family: 'DeepSeek V4 / R1', route: '高性价比推理', positioning: '推理、代码、开放权重与低成本 API', capabilities: ['推理', '代码', '低成本'], deployment: 'API / 自建 / 云厂商托管', price: 'V4 Flash ¥0.14 / ¥0.28', source: 'https://api-docs.deepseek.com/quick_start/pricing' },
  ...
  { region: '国内', vendor: 'MiniMax', family: 'M2.7 / Hailuo / Speech', route: 'Agent 与内容生成', positioning: '长任务 Agent、语音、视频、角色互动与办公', capabilities: ['Agent', '语音', '视频'], deployment: 'API / 订阅 / 专属部署', price: 'M2.7 ¥2.1 / ¥8.4', source: 'https://platform.minimaxi.com/docs/guides/pricing-paygo' },
  ...
  { region: '国内', vendor: '商汤 / 日日新', family: 'SenseNova V6.x', route: '视觉与企业 Agent', positioning: '视觉、多模态、办公数据分析与企业交付', capabilities: ['视觉', '多模态', '企业'], deployment: 'API / 企业平台 / 私有化', price: '按模型与服务档位计费', source: 'https://platform.sensenova.cn/product/APIService/pricing' },
...
export const subscriptionPlans: SubscriptionPlan[] = [
  ...
  { region: '海外', vendor: 'OpenAI', product: 'ChatGPT', plan: 'Plus', monthlyFee: '$20 / 月', coreModel: 'GPT-5.6 Sol、Codex', benefits: '更高推理、文件、Deep Research、图像、语音和代码额度', note: '无年付方案；用量采用消息滚动限额。', uses: ['日常问答', '写稿办公', '写代码', '做视频', '做研究'], paid: true, source: 'https://chatgpt.com/pricing/' },
  { region: '海外', vendor: 'OpenAI', product: 'ChatGPT', plan: 'Pro 5×', monthlyFee: '$100 / 月', coreModel: 'GPT-5.6 Sol Pro 等', benefits: '约 5× Plus 用量；更高优先级 Codex 与 Deep Research', note: '面向高频使用的个人用户。', uses: ['写代码', '做研究'], paid: true, source: 'https://help.openai.com/en/articles/9793128-about-chatgpt-pro-tiers' },
  { region: '海外', vendor: 'OpenAI', product: 'ChatGPT', plan: 'Pro 20×', monthlyFee: '$200 / 月', coreModel: 'GPT-5.6 Sol Pro、最高上下文', benefits: '约 20× Plus 用量；最高个人推理、Codex 与 Deep Research 额度', note: '个人自助最高档；API 使用另行计费。', uses: ['写代码', '做视频', '做研究'], paid: true, source: 'https://help.openai.com/en/articles/9793128-about-chatgpt-pro-tiers' },

  { region: '海外', vendor: 'Anthropic', product: 'Claude', plan: 'Free', monthlyFee: '$0', coreModel: 'Claude 最新模型（限额）', benefits: '基础对话、Projects、文件创建、代码执行与联网搜索', note: '会话额度按窗口重置；高峰期可能排队。', uses: ['日常问答'], paid: false, source: 'https://claude.com/pricing' },
  { region: '海外', vendor: 'Anthropic', product: 'Claude', plan: 'Pro', monthlyFee: '$20 / 月', coreModel: 'Claude Sonnet / Opus / Haiku，以选择器为准', benefits: 'Claude Code、Cowork、Design、Science、Research 与无限 Projects', note: '年付折算约 $17/月；使用量按会话窗口限制。', uses: ['写稿办公', '写代码', '做研究'], paid: true, source: 'https://claude.com/pricing' },
  ...
  { region: '海外', vendor: 'Google', product: 'Gemini', plan: 'AI Plus', monthlyFee: '$4.99 / 月', coreModel: 'Gemini Flash Thinking', benefits: '2× Gemini 用量、400GB 云盘、Flow、Gmail 与 NotebookLM', note: '美国官网 400GB 方案基准价；另有 2TB 版本。', uses: ['日常问答', '写稿办公'], paid: true, source: 'https://one.google.com/about/google-ai-plans/?hl=en-US' },
  ...
  { region: '海外', vendor: 'Google', product: 'Gemini', plan: 'AI Pro', monthlyFee: '$19.99 / 月', coreModel: 'Gemini Pro、Deep Research', benefits: '4× 用量、5TB 云盘、Deep Research、NotebookLM Plus 与 Workspace 内嵌', note: '美国官网基准方案；存储规格可能随账号变化。', uses: ['写稿办公', '做视频', '做研究'], paid: true, source: 'https://one.google.com/about/google-ai-plans/?hl=en-US' },
  { region: '海外', vendor: 'Google', product: 'Gemini', plan: 'AI Ultra 5×', monthlyFee: '$99.99 / 月', coreModel: 'Gemini Pro、Deep Think', benefits: '约 5× Pro 用量、20TB 云盘及更高 Veo 额度', note: '美国官网基准价；地区、税费与账号方案可能不同。', uses: ['写代码', '做视频'], paid: true, source: 'https://one.google.com/about/google-ai-plans/?hl=en-US' },
  { region: '海外', vendor: 'Google', product: 'Gemini', plan: 'AI Ultra 20×', monthlyFee: '$199.99 / 月', coreModel: 'Gemini Pro、Deep Think', benefits: '约 20× Pro 用量、30TB 云盘及最高创作额度', note: '个人高用量档；价格为美国官网基准。', uses: ['做视频'], paid: true, source: 'https://one.google.com/about/google-ai-plans/?hl=en-US' },
  ...
  { region: '海外', vendor: 'Perplexity', product: 'Perplexity', plan: 'Pro', monthlyFee: '$20 / 月', coreModel: 'Sonar 2、GPT-5.6 Terra、Claude Sonnet 5、Gemini 3.1 Pro、Kimi K3 等', benefits: '扩展 Pro Search 与 Research、模型切换、文件应用创建、图片与视频生成', note: '美国官网 Web 基准价；年付 $200；每项目最多 50 个文件。', uses: ['做研究'], paid: true, source: 'https://www.perplexity.ai/help-center/en/articles/10352901-what-is-perplexity-pro' },
  ...
  { region: '海外', vendor: 'Perplexity', product: 'Perplexity', plan: 'Max', monthlyFee: '$200 / 月', coreModel: 'Pro 模型外加 GPT-5.6 Sol、Claude Opus 5', benefits: '最高研究额度、Model Council、Brain 预览与每月 Computer credits', note: '美国官网 Web 基准价；年付 $2,000。', uses: ['做研究'], paid: true, source: 'https://www.perplexity.ai/help-center/en/articles/11680686-perplexity-max' },
...
export const prices: PriceRow[] = [
  ...
  { vendor: 'Anthropic', model: 'Claude Sonnet 5', currency: 'USD', input: 2, cached: .2, output: 10, tier: '均衡', condition: '长上下文和缓存写入另有条件', source: 'https://platform.claude.com/docs/en/about-claude/pricing' },
  ...
  { vendor: 'Google', model: 'Gemini 3.1 Pro', currency: 'USD', input: 1.5, cached: .15, output: 9, tier: '旗舰', condition: '长上下文阶梯价', source: 'https://ai.google.dev/gemini-api/docs/pricing' },
  ...
  { vendor: 'Cohere', model: 'Command A+', currency: 'USD', input: 2.5, output: 10, tier: '均衡', condition: '私有 Vault 方案另计', source: 'https://docs.cohere.com/docs/command-a' },
  ...
  { vendor: 'DeepSeek', model: 'DeepSeek V4 Flash', currency: 'CNY', input: .14, cached: .0028, output: .28, tier: '低成本', condition: '1M 上下文', source: 'https://api-docs.deepseek.com/quick_start/pricing' },
...
export const timeline: Record<string, { vendor: string; model: string; shift: string; source: string }[]> = {
  ...
  '2026': [
    ...
    { vendor: 'Anthropic', model: 'Claude 5', shift: '长上下文、长期 Agent 与价格再分层', source: 'https://platform.claude.com/docs/en/release-notes/overview' },
    ...
    { vendor: 'GLM / Kimi', model: 'GLM-5.x / Kimi K3', shift: '国内厂商聚焦代码、Agent 和复杂任务', source: 'https://bigmodel.cn/pricing' },
  ],
};

export const scenarios = [
  { title: '复杂推理 / 长周期 Agent', priority: '高', models: 'GPT-5.6、Claude、GLM-5.2、DeepSeek V4 Pro、Kimi K3', metric: '任务成功率、人工接管率、步骤数、每成功任务成本', action: '用 100—300 条真实任务做端到端评测。' },
  { title: '代码 Agent', priority: '高', models: 'GPT-5.6、Claude、Grok、Qwen Coder、DeepSeek、GLM、Kimi Code', metric: 'SWE 任务通过率、测试通过率、仓库理解和时延', action: '补全与仓库级 Agent 分开评测。' },
...
export const cases = [
  ...
  { field: '语音客服', org: 'DoorDash', model: 'Claude 3 Haiku on Bedrock', result: '首响应延迟约 2.5 秒；通过 A/B 测试验证方案', evidence: 'A｜AWS 案例', source: 'https://aws.amazon.com/solutions/case-studies/doordash-bedrock-case-study/' },
  { field: '代码', org: 'Palo Alto Networks', model: 'Claude Haiku + Sonnet', result: '分层使用小模型补全、强模型处理复杂任务', evidence: 'A｜官方案例', source: 'https://www.anthropic.com/customers/palo-alto-networks' },
  ...
  { field: '医疗理赔', org: 'MediConCen', model: 'Gemini + Vertex AI', result: '文档抽取准确率 98%；处理速度从小时降到分钟', evidence: 'A｜官方案例', source: 'https://cloud.google.com/customers/mediconcen' },
  ...
  { field: '气象科学', org: '深圳市气象局', model: '盘古气象大模型', result: '区域天气预报与科学计算场景', evidence: 'A｜官方案例', source: 'https://www.huawei.com/cn/news/2024/3/pangu-weather' },
];
