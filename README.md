...
> 数据快照：2026-09-14。价格、模型能力和产品权益会持续变化，采购或上线前请点击每条记录附带的官方来源复核。
...
网页版精选展示 **52 个订阅档位、24 家厂商、51 个时间线节点、35 条 API 价格、6 类场景和 11 个公开案例**。下载区提供包含 8 个工作表的完整 Excel 数据集，其中收录 108 个时间线节点、58 条 API 价格和 26 个公开案例。
