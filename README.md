...
> 数据快照：2026-08-24。价格、模型能力和产品权益会持续变化，采购或上线前请点击每条记录附带的官方来源复核。
...
网页版精选展示 **45 个订阅档位、24 家厂商、28 个时间线节点、21 条 API 价格、6 类场景和 10 个公开案例**。下载区提供包含 8 个工作表的完整 Excel 数据集，其中收录 96 个时间线节点、44 条 API 价格和 25 个公开案例。
...
站点按“每周核验”流程设计；当前仓库不包含无人值守抓取或自动改价脚本，避免页面结构变化或区域价格导致错误更新。
